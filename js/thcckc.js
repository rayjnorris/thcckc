...
Webflow.require('ix').init([
  {"slug":"new-interaction","name":"New Interaction","value":{"style":{"opacity":0},"triggers":[{"type":"slider","stepsA":[{"opacity":1,"transition":"opacity 1000ms linear 0ms"}],"stepsB":[{"opacity":0,"transition":"opacity 1000ms linear 0ms"}]}]}},
  {"slug":"opening-message","name":"opening_message","value":{"style":{},"triggers":[{"type":"load","stepsA":[{"wait":"3000ms","display":"block","opacity":1,"transition":"transform 1000ms ease 0, opacity 500ms ease-in-out 0","scaleX":1,"scaleY":1,"scaleZ":1},{"wait":"3000ms","display":"block","opacity":0,"transition":"transform 1000ms ease 0, opacity 3000ms ease-out 0","scaleX":0.01,"scaleY":0.01,"scaleZ":1},{"display":"none"}],"stepsB":[]}]}}
]);
